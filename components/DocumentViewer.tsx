  ...
  return (
    <div className="bg-white border border-gray-300 shadow-md p-6 max-w-2xl mx-auto font-serif text-sm relative">
      ...
      <div className="flex justify-end">
        <div className="w-1/2">
          {content.totals?.bases && (
            <div className="grid grid-cols-3 gap-2 border-t border-black pt-2 text-xs mb-2 bg-gray-50 p-1">
          ...
          <div className="flex justify-between font-bold text-lg border-t-2 border-black mt-2 pt-1 bg-yellow-50 px-2 py-1">
            <span>A PAYER:</span>
